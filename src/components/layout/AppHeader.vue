        ...
        <div class="flex items-center">
          ...
          <div class="hidden ml-10 space-x-8 lg:block">
            <router-link v-for="link in navigation" :key="link.name" :to="link.href"
              ...
              class="lg:text-2xl font-medium text-white hover:bg-indigo-500 hover:bg-opacity-75 px-5 py-3 rounded-lg"
...
export default {
  methods: {
    login() {
      console.log("logging in with NEAR");
      this.authButton = "user.near ( Ⓝ 107.32 )";
    },
  },
  setup() {
    const authButton = ref("Login with NEAR Wallet");
    return {
      authButton,
      navigation,
    };
